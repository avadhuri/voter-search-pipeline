"""
Extract Chandigarh old SIR (2002) voter roll PDFs to CSV.
...
Usage:
    python scripts/extractors/extract_chandigarh.py                    # all downloaded ACs
...
def main():
    ap = argparse.ArgumentParser(description="Extract Chandigarh SIR PDFs to CSV")
