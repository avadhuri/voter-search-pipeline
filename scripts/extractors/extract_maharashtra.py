"""
Extract Maharashtra old SIR (2002) voter roll PDFs to CSV.

PDF has ruled tables extractable via pdfplumber.extract_tables().
Text is in Legacy Devanagari (DVTTSurekh) - extracted as-is (raw characters preserved).

Usage:
    python scripts/extractors/extract_maharashtra.py
    python scripts/extractors/extract_maharashtra.py --combined
"""
...
def main():
    ...
    ap.add_argument("--out-dir", default="output/csv/maharashtra")
